  ...
  return (
    <div>
      <MDBFooter className="text-center text-lg-left">
          ...
          <MDBContainer className="text-center text-md-start mt-5">
            <MDBRow className="mt-3">
              <MDBCol md="3" lg="4" xl="3" className="mx-auto mb-4">
                ...
                <p>
                  Fishtories is a collaborative project designed by members of
                  Code Platoon’s Romeo Cohort. We built this site to serve as a
                  showcase of our collective problem solving and design skills,
                  as such the fishing data displayed is for demonstration
                  purposes only. All of our team members are US military
                  veterans or veteran spouses. If you have questions about this
                  project or would like to collaborate on future projects, feel
                  free to connect with us on Linkedin.
                </p>
              </MDBCol>
        ...
        >
          &copy; {new Date().getFullYear()} Fishtories
        </div>
      </MDBFooter>
    </div>
  );
